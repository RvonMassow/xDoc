...
\section{Resource and EObject Descriptions}
...
\hyperref[dependencyInjection]{Guice} (
\phantomsection\label{dependencyInjection}
). That implementation looks up any 
...
\subsection{ IQualifiedNameProvider }
...
public class FowlerDslQualifiedNameProvider extends DefaultDeclarativeQualifiedNameProvider {

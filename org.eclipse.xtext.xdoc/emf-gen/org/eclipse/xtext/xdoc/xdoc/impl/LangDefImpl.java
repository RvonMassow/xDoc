 ...
 * @generated
 */
public class LangDefImpl extends MinimalEObjectImpl.Container implements LangDef
{
	/**
	...
	{
		return XdocPackage.Literals.LANG_DEF;
	}
	...
	public EList<String> getKeywords()
	{
		if (keywords == null)
		{
			keywords = new EDataTypeUniqueEList<String>(String.class, this, XdocPackage.LANG_DEF__KEYWORDS);
		}
		return keywords;
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XdocPackage.LANG_DEF__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case XdocPackage.LANG_DEF__KEYWORDS:
				return getKeywords();
			case XdocPackage.LANG_DEF__NAME:
				return getName();
		}

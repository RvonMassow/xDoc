...
public class ImagesAdapterFactory extends AdapterFactoryImpl
{
	 ...
	 * @generated
	 */
	protected ImagesSwitch<Adapter> modelSwitch =
		new ImagesSwitch<Adapter>()
		{
			@Override
			public Adapter caseImageProxy(ImageProxy object)
			{
				return createImageProxyAdapter();
			}
			@Override

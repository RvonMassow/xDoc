...
public interface XDocPackage extends EPackage
{
   ...
   * @ordered
   */
  int LINK__LINK = MARK_UP_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int LINK_FEATURE_COUNT = MARK_UP_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int IMAGE_REF__IMAGE = MARK_UP_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int IMAGE_REF_FEATURE_COUNT = MARK_UP_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipse.xtext.xdoc.xDoc.Link#getLink <em>Link</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Link</em>'.
   * @see org.eclipse.xtext.xdoc.xDoc.Link#getLink()
   * @see #getLink()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipse.xtext.xdoc.xDoc.ImageRef#getImage <em>Image</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute IMAGE_REF__IMAGE = eINSTANCE.getImageRef_Image();

...
public class XdocGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class CodeBlockElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cCodeKeyword_1_0 = (Keyword)cAlternatives_1.eContents().get(0);
		private final Assignment cRawAssignment_1_1 = (Assignment)cAlternatives_1.eContents().get(1);
		private final Keyword cRawCodeRawKeyword_1_1_0 = (Keyword)cRawAssignment_1_1.eContents().get(0);
		private final Group cGroup_2 = (Group)cGroup.eContents().get(2);
		private final RuleCall cANY_WSParserRuleCall_2_0 = (RuleCall)cGroup_2.eContents().get(0);
		...
		//"code["
		public Keyword getCodeKeyword_1_0() { return cCodeKeyword_1_0; }

		//raw?="code-raw["
		public Assignment getRawAssignment_1_1() { return cRawAssignment_1_1; }

		//"code-raw["
		public Keyword getRawCodeRawKeyword_1_1_0() { return cRawCodeRawKeyword_1_1_0; }
